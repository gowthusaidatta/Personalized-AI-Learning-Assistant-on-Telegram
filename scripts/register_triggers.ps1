# Register OpenClaw standing order and a placeholder cron job (PowerShell)
...
Write-Host "Standing order and placeholder cron command issued. Replace {TIMEZONE} and re-run the cron add command with a real timezone if needed."